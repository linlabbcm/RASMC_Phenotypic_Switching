...
dim(signal_table)
density_table = read.delim('/storage/cylin/grail/projects/rasmc_all/motif_density/CArG_box_scramble_density_from_fasta_full_length.txt',header=TRUE)
dim(density_table)
density_table[1:5,]
...
write.table(compare_table,'/storage/cylin/grail/projects/rasmc_all/motif_density/subpeak_to_region_carg_box_scramble_motif_density_table.txt',row.names=FALSE,col.names=TRUE,quote=FALSE,sep='\t')

#example
pdf(file = "/storage/cylin/grail/projects/rasmc_all/figures/compare_vectors_log2brd4_carg_box_24v0_scramble_motif_density.pdf")
v2 = compare_table$`MOTIFS/KB`
v1 = compare_table$LOG2FC_24v0

compareVectors(v1,v2,'brd4 24_v_0','CArG Box motif density','Log2 Fold Change in 24H Brd4 versus motif density')
dev.off()



#example
pdf(file = "/storage/cylin/grail/projects/rasmc_all/figures/compare_vectors_log2brd4_carg_box_scramble_2v0_motif_density.pdf")
v2 = compare_table$`MOTIFS/KB`
v1 = compare_table$LOG2FC_2v0

compareVectors(v1,v2,'brd4 2_v_0','CArG Box motif density','Log2 Fold Change in 2H Brd4 versus motif density')
dev.off()

pdf(file = "/storage/cylin/grail/projects/rasmc_all/figures/compare_vectors_log2brd4_24v2_carg_box_scramble_motif_density.pdf")
v2 = compare_table$`MOTIFS/KB`
v1 = log2(mean_24h/mean_2h)

compareVectors(v1,v2,'brd4 24_v_2','CArG Box motif density','Log2 Fold Change in 24H v 2H Brd4 versus motif density')
dev.off()
