...
region_table = read.delim('/storage/cylin/grail/projects/rasmc_all/TF_Network/motif_density/subpeak_coords_table.txt',header=FALSE)
...
density_table = read.delim('/storage/cylin/grail/projects/rasmc_all/TF_Network/motif_density/seq_density_from_fasta_full_length.txt',header=TRUE)
...
compare_table = cbind(region_table[,1:4],region_map[,1],density_table[,1]*1000,density_table[,1]*density_table[3],density_table[,2:3],mean_unstim,mean_2h,mean_24h,log2(mean_2h/mean_unstim),log2(mean_24h/mean_unstim))
...
#write.table(compare_table,'/storage/cylin/grail/projects/rasmc_all/tables/subpeak_to_region_motif_density_table.txt',row.names=FALSE,col.names=TRUE,quote=FALSE,sep='\t')
