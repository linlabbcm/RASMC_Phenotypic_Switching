a0H_GENE_TABLE = read.delim('/storage/cylin/grail/projects/rasmc_all/enhancerPromoter/old_activity/RASMC_BRD4_UNSTIM_REP1_0_STITCH_-_JQ1/RASMC_BRD4_UNSTIM_REP1_0_STITCH_-_JQ1_GENE_TABLE.txt', sep = '\t', header = TRUE)
a2H_GENE_TABLE = read.delim('/storage/cylin/grail/projects/rasmc_all/enhancerPromoter/old_activity/RASMC_BRD4_PDGF_2H_REP2_0_STITCH_-_JQ1/RASMC_BRD4_PDGF_2H_REP2_0_STITCH_-_JQ1_GENE_TABLE.txt', sep = '\t', header = TRUE)
a24H_GENE_TABLE = read.delim('/storage/cylin/grail/projects/rasmc_all/enhancerPromoter/old_activity/RASMC_BRD4_PDGF_24H_REP2_0_STITCH_-_JQ1/RASMC_BRD4_PDGF_24H_REP2_0_STITCH_-_JQ1_GENE_TABLE.txt', sep = '\t', header = TRUE)
...
promoterTable = cbind(a0H_GENE_TABLE[,2],a2H_GENE_TABLE[,2],a24H_GENE_TABLE[,2])
#print(promoterTable[1:10,])
enhancerTable = cbind(a0H_GENE_TABLE[,3],a2H_GENE_TABLE[,3],a24H_GENE_TABLE[,3])
...
# 
# 
# pdf(file = '/storage/cylin/grail/projects/rasmc_all/figures_old/BRD4_CLUSTER_A_B_C_D_promoter_enhancer_boxplots_old_reps.pdf')
# par(mfrow=c(2,2))
# 
# ############################################################################################################
...
# 
# 
# pdf(file = '/storage/cylin/grail/projects/rasmc_all/figures/BRD4_old/BRD4_clusters_A_B_C_D_0h_normalized_enhancer_promoter_cumulative_boxplots_old_reps.pdf')
# par(mfrow=c(2,2))
# 
# 
# 
...
pdf(file='/storage/cylin/grail/projects/rasmc_all/figures/BRD4_old/ALL_ACTIVE_GENES_BRD4_ENH_vs_PRO_PIE_CHARTS_old_reps.pdf')
par(mfrow=c(3,1))
...
# ###########################################################
# 
# pdf(file='/storage/cylin/grail/projects/rasmc_all/figures/BRD4_old/CLUSTERS_BRD4_ENH_vs_PRO_PIE_CHARTS_old_reps.pdf')
# par(mfrow=c(3,1))
# 
# 
# slices <- c(A0p,A0e)
...
b0H_GENE_TABLE = read.delim('/storage/cylin/grail/projects/rasmc_all/enhancerPromoter/old_activity/RASMC_BRD4_UNSTIM_NEW_0_STITCH_-_JQ1/RASMC_BRD4_UNSTIM_NEW_0_STITCH_-_JQ1_GENE_TABLE.txt', sep = '\t', header = TRUE)
b2H_GENE_TABLE = read.delim('/storage/cylin/grail/projects/rasmc_all/enhancerPromoter/old_activity/RASMC_BRD4_PDGF_2H_NEW_0_STITCH_-_JQ1/RASMC_BRD4_PDGF_2H_NEW_0_STITCH_-_JQ1_GENE_TABLE.txt', sep = '\t', header = TRUE)
b24H_GENE_TABLE = read.delim('/storage/cylin/grail/projects/rasmc_all/enhancerPromoter/old_activity/RASMC_BRD4_PDGF_24H_NEW_0_STITCH_-_JQ1/RASMC_BRD4_PDGF_24H_NEW_0_STITCH_-_JQ1_GENE_TABLE.txt', sep = '\t', header = TRUE)

promoterTable = cbind(b0H_GENE_TABLE[,2],b2H_GENE_TABLE[,2],b24H_GENE_TABLE[,2])
#print(promoterTable[1:10,])
enhancerTable = cbind(b0H_GENE_TABLE[,3],b2H_GENE_TABLE[,3],b24H_GENE_TABLE[,3])
#print(enhancerTable[1:10,])
cumulativeTable = cbind((promoterTable[,1]+enhancerTable[,1]),(promoterTable[,2]+enhancerTable[,2]),(promoterTable[,3]+enhancerTable[,3]))
#print(cumulativeTable[1:10,])
...
# 
# 
# pdf(file = '/storage/cylin/grail/projects/rasmc_all/figures/BRD4_old/BRD4_CLUSTER_A_B_C_D_promoter_enhancer_boxplots_new_reps.pdf')
# par(mfrow=c(2,2))
# 
# ############################################################################################################
# table_PA <- p_matrix[clusterArows,]
...
# 
# 
# pdf(file = '/storage/cylin/grail/projects/rasmc_all/figures/BRD4_old/BRD4_clusters_A_B_C_D_0h_normalized_enhancer_promoter_cumulative_boxplots_new_reps.pdf')
# par(mfrow=c(2,2))
# 
# 
# ############################################################################################################################################
...
pdf(file='/storage/cylin/grail/projects/rasmc_all/figures/BRD4_old/ALL_ACTIVE_GENES_BRD4_ENH_vs_PRO_PIE_CHARTS_new_reps.pdf')
par(mfrow=c(3,1))
...
# ###########################################################
# 
# pdf(file='/storage/cylin/grail/projects/rasmc_all/figures/BRD4_old/CLUSTERS_BRD4_ENH_vs_PRO_PIE_CHARTS_new_reps.pdf')
# par(mfrow=c(3,1))
# 
# 
# slices <- c(A0p,A0e)
