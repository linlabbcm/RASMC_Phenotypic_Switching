...
t.test(table_CD[,1],table_CD[,2])
t.test(table_CD[,1],table_CD[,3])
t.test(table_CD[,2],table_CD[,3])
...
gene_name=c('Spry2','Col1a1')
pdf('/storage/cylin/grail/projects/rasmc_all/figures/Spry2_Col1a1_brd4_bargraphs.pdf')
par(mfrow=c(3,2))
# 
